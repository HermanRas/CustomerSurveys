                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type=" text" class="form-control" id="inlineFormInputGroup" value="<?php echo $Rec['Question']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group col-md-2">
                                    <a class="form-control btn btn-primary" href="admin_action.php?qid=<?php echo $Rec['id']; ?>">
                                        Toggle
                                    </a>
                                </div>
                            </div>
